...
def new_request_retaguarda(request):
    ...
    return render(request, "retaguarda/new_request_retaguarda.html", context)
...
def request_ci_ret(request):
    ...
    return render(request, 'retaguarda/new_request_retaguarda', {'form': form})
...
def request_apontamentos_ret(request):
    ...
    return render(request, 'retagurda/new_request_retaguarda.html', {'form': form, 'is_apontamento': True})
