...
def new_request_cadastro(request):
    ...
    return render(request, "cadastro/new_request_cadastro.html", context)
...
def salvar_malote_cadastro(request):
    ...
    return render(request, 'cadastro/new_request_cadastro.html', {'form': form})
...
def request_ci_cad(request):
    ...
    return render(request, 'cadastro/new_request_cadastro', {'form': form})
...
def request_apontamentos_cad(request):
    ...
    return render(request, 'cadastro/new_request_cadastro.html', {'form': form, 'is_apontamento': True})
