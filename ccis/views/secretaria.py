...
def request_ci_sec(request):
    ...
    return render(request, 'secretaria/new_request_secretaria', {'form': form})
...
def request_apontamentos_sec(request):
    ...
    return render(request, 'secretaria/new_request_secretaria.html', {'form': form, 'is_apontamento': True})
